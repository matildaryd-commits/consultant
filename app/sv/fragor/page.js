...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.matildarydow.com/sv/fragor',
  ...
  alternates: {
    canonical: 'https://www.matildarydow.com/sv/fragor',
    languages: {
      'sv': 'https://www.matildarydow.com/sv/fragor',
      'en': 'https://www.matildarydow.com/en/faq',
      'x-default': 'https://www.matildarydow.com/sv/fragor',
    },
  },
}
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Hem',
                item: 'https://www.matildarydow.com/sv',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Frågor & Svar',
                item: 'https://www.matildarydow.com/sv/fragor',
              },
            ],
          }),
        }}
      ...
      >
        ...
        {faqs.map(faq => (
          <article
            ...
            id={`static-${faq.id}`}
          >
            <h3 id={faq.id}>{faq.sv.question}</h3>
            <div>
              {faq.sv.answer.split('\n\n').map((paragraph, i) => (
