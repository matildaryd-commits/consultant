...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.matildarydow.com/en/faq',
  ...
  alternates: {
    canonical: 'https://www.matildarydow.com/en/faq',
    languages: {
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Home',
                item: 'https://www.matildarydow.com/en',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Q&A',
                item: 'https://www.matildarydow.com/en/faq',
              },
            ],
          }),
        }}
